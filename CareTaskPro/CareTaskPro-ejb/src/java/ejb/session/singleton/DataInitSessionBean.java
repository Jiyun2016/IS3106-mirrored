...
public class DataInitSessionBean {
    ...
    private void initializeTaskData() {
        ...
        taskControllerLocal.createNewTask(new TaskEntity(CategoryString.COMPANIONSHIP, "housework", new Date((System.currentTimeMillis() + 60000 * 2500)), new Date((System.currentTimeMillis() + 60000 * 3000)), TaskStatusString.PENDING, r));
